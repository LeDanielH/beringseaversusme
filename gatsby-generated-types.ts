...
export type DefaultSeoQueryQuery = { site?: { siteMetadata?: { title?: string | null, description?: string | null, author?: string | null } | null } | null };

export type NavigationQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type NavigationQueryQuery = { allMdx: { edges: Array<{ node: { slug?: string | null, id: string, frontmatter?: { category?: string | null } | null } }> } };
...
export type BlogPostQueryQuery = { mdx?: { body: string } | null };
